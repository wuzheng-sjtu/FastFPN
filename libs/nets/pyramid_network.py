  ...
  with tf.variable_scope('pyramid'):
    with slim.arg_scope(arg_scope):
      ...
      for c in range(4, 1, -1):
        ...
        # but t.image is not contrained into just image
...
#
  ...
  losses = [rpn_box_losses, rpn_cls_losses, refined_box_losses, refined_cls_losses]
...
def build(end_points, image_height, image_width, pyramid_map, 
    ...
    pred_boxes, pred_classes = decode_output(outputs)
